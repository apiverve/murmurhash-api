...
```gradle
dependencies {
    implementation 'com.github.apiverve:murmurhash-api:1.1.14'
}
```
...
```java
import com.apiverve.murmurhash.MurmurHashAPIClient;
import com.apiverve.murmurhash.APIResponse;
import com.apiverve.murmurhash.APIException;

// Initialize the client
MurmurHashAPIClient client = new MurmurHashAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/murmurhash](https://docs.apiverve.com/ref/murmurhash)
...
- **Documentation:** [https://docs.apiverve.com/ref/murmurhash](https://docs.apiverve.com/ref/murmurhash)
- **Issues:** [GitHub Issues](https://github.com/apiverve/murmurhash-api/issues)
