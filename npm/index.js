...
class murmurhashWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/murmurhash');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"seed":{"type":"integer","required":false,"min":0,"default":0},"variant":{"type":"string","required":false,"default":"32"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/murmurhash`);
        }
    }
...
module.exports = murmurhashWrapper;
