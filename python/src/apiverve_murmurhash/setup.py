...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/murmurhash',
        'Source': 'https://github.com/apiverve/murmurhash-api',
        'Bug Tracker': 'https://github.com/apiverve/murmurhash-api/issues'
    },
    classifiers=[
