...
namespace APIVerve.API.MurmurHash
{
    ...
    /// <summary>
    /// Client for the MurmurHash API
    /// </summary>
    public class MurmurHashAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/murmurhash";
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "seed", new ValidationRule { Type = "integer", Required = false, Min = 0 } },
            { "variant", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public MurmurHashAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MurmurHashAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public MurmurHashAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MurmurHashQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(MurmurHashQueryOptions options)
        {
        ...
        public ResponseObj Execute(MurmurHashQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(MurmurHashQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(MurmurHashQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(MurmurHashQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(MurmurHashQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(MurmurHashQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(MurmurHashQueryOptions options)
        {
