    ...
    class MurmurHashExample
    {
        ...
        static async Task<JsonDocument> CallMurmurHashAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { text &#x3D; &quot;hello world&quot;, seed &#x3D; 0, variant &#x3D; &quot;32&quot; };
        ...
        {
            Console.WriteLine("📤 Calling MurmurHash API...\n");

            var result = await CallMurmurHashAPI();
