...
// Request contains the parameters for the MurmurHash API.
//
// Parameters:
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"seed": {Type: "integer", Required: false, Min: float64Ptr(0)},
...
// ResponseData contains the data returned by the MurmurHash API.
